...
public class JavaObjectAsPayloadExample
{

    @Test
    public void postRequestUsingJavaObjectPayload() {
        ...
        PlaceAddRequest request = new PlaceAddRequest(location, 50, "Frontline house",
                "(+91) 983 893 3937", "29, side layout, cohen 09", types,
                "http://google.com", "French-IN");

        // Send POST request with payload object
        ...
        // Parse response and extract place ID
        JsonPath jsonPath = response.jsonPath();
        String placeId = jsonPath.getString("place_id");
        System.out.println("Place ID: " + placeId);
    }

    // Java class for payload object
